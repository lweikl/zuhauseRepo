import {Tagesaufgaben} from "./tagenaufgaben.js";
import {Aufgabe} from "./aufgaben.js";
export function dailyTasks() :Aufgabe[] {
    let taeglich: Aufgabe[] = [ 
...
export function allThreeDays():Aufgabe[] {
    let jedenDrittenTag:Aufgabe[] =[ 
...
export function onceAWeek():Aufgabe[]{
    let einmalProWoche:Aufgabe[]=[
{
...
export const aufgaben: Tagesaufgaben[] = [
    {
        datum: "2026-08-10",
        aufgaben: dailyTasks()
    },
